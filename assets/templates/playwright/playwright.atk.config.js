...
module.exports = {
  ...
  articleAddUrl: 'node/add/news_article',
  ...
  termAddUrl: 'admin/structure/taxonomy/manage/file_categories/add',
  termEditUrl: 'taxonomy/term/{tid}/edit',
  termDeleteUrl: 'taxonomy/term/{tid}/delete',
  termListUrl: 'admin/structure/taxonomy/manage/file_categories/overview',
